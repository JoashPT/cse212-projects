...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Sue is returned instead of Bob (Person.Enqueue not fixed)
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Sue is retruend instead of Bob (Person.Enqueue not fixed)
    //                  Sue is returned instead of Tim (Person.GetNextPerson not fixed)
    ...
    // Defect(s) Found: Sue appears instead of Tim (Person.Enqueue and Person.GetNextPerson is not fixed)
